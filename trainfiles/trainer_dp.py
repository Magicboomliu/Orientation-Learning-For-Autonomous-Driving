...
class Trainer(object):
    ...
    def train_one_epoch(self, epoch, round,iterations,summary_writer):
        ...
        for i_batch, sample_batched in enumerate(self.train_loader):
            ...
            cropped_Rois = torch.autograd.Variable(sample_batched['cropped_rois'].cuda(), requires_grad=False)
            labels = torch.autograd.Variable(sample_batched['labels'].cuda(), requires_grad=False)
